    ...
    <div className="dp-fingerprint flex flex-col flex-grow flex-start">
      ...
      <div className="explanation">
        <div className="flex flex-col items-center">
          ...
          <Text type="text-3" className="text-center text-dp-gray mt-2 w-4/5">A quicker way to access your accounts and confirm transactions</Text>
        </div>
      </div>
      ...
      <Link to="/home" className="w-full">
        ...
        <p className="text-center text-dp-purple font-medium text-sm pt-6 pb-3">Skip</p>
      </Link>
    </div>
  )
}