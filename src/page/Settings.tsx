  ...
  return (
    <div className="flex flex-col flex-grow flex-start content-start items-start justify-start">
      ...
      <section className="profile w-full">
        <div className="flex flex-row items-center">
          ...
          <div className="ml-auto">
            <QrCodeSharp height="2rem" width="2rem" color="var(--Purple-text)"/>
          </div>
        </div>
      </section>
      ...
      <section className="w-full">
        <Text type="text-3" className="text-dp-text-gray mb-3">Account</Text>
        <div className="flex flex-col grow">
          <div className="flex flex-row grow">
            <Cash height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
            <Text type="text-1" className="ml-3">Currency</Text>
            <Text type="text-1" className="ml-auto text-dp-text-gray">$ USD</Text>
          </div>
          <div className="flex flex-row grow mt-3">
            <Language height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
            <Text type="text-1" className="ml-3">Language</Text>
            <Text type="text-1" className="ml-auto text-dp-text-gray">English</Text>
          </div>
        </div>
      </section>
      ...
      <section className="w-full">
        <Text type="text-3" className="text-dp-text-gray mb-3">Security</Text>
        <div className="flex flex-col grow">
          <div className="flex flex-row grow">
            <FingerPrint height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
          ...
          <div className="flex flex-row grow mt-3">
            <Keypad height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
      ...
      <section className="w-full">
        <Text type="text-3" className="text-dp-text-gray mb-3">Notifications</Text>
        <div className="flex flex-col grow">
          <div className="flex flex-row grow">
            <Notifications height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
      ...
      <section className="w-full">
        <Text type="text-3" className="text-dp-text-gray mb-3">About</Text>
        <div className="flex flex-col grow">
          <div className="flex flex-row grow">
            <HelpCircle height="1.5rem" width="1.5rem" color="var(--Purple-text)" />
